...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AllRouteJobUpdates', 'model/DispatchRoute', 'model/DispatchRouteCreate', 'model/DispatchRouteHistory', 'model/DispatchRoutes', 'model/ErrorResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AllRouteJobUpdates'), require('../model/DispatchRoute'), require('../model/DispatchRouteCreate'), require('../model/DispatchRouteHistory'), require('../model/DispatchRoutes'), require('../model/ErrorResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SamsaraApi) {
      root.SamsaraApi = {};
    }
    root.SamsaraApi.RoutesApi = factory(root.SamsaraApi.ApiClient, root.SamsaraApi.AllRouteJobUpdates, root.SamsaraApi.DispatchRoute, root.SamsaraApi.DispatchRouteCreate, root.SamsaraApi.DispatchRouteHistory, root.SamsaraApi.DispatchRoutes, root.SamsaraApi.ErrorResponse);
  }
}(this, function(ApiClient, AllRouteJobUpdates, DispatchRoute, DispatchRouteCreate, DispatchRouteHistory, DispatchRoutes, ErrorResponse) {
  'use strict';
