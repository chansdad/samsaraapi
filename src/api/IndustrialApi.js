...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DataInputHistoryResponse', 'model/ErrorResponse', 'model/GroupParam', 'model/HistoryParam1', 'model/InlineResponse2004', 'model/InlineResponse2005', 'model/MachineHistoryResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DataInputHistoryResponse'), require('../model/ErrorResponse'), require('../model/GroupParam'), require('../model/HistoryParam1'), require('../model/InlineResponse2004'), require('../model/InlineResponse2005'), require('../model/MachineHistoryResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SamsaraApi) {
      root.SamsaraApi = {};
    }
    root.SamsaraApi.IndustrialApi = factory(root.SamsaraApi.ApiClient, root.SamsaraApi.DataInputHistoryResponse, root.SamsaraApi.ErrorResponse, root.SamsaraApi.GroupParam, root.SamsaraApi.HistoryParam1, root.SamsaraApi.InlineResponse2004, root.SamsaraApi.InlineResponse2005, root.SamsaraApi.MachineHistoryResponse);
  }
}(this, function(ApiClient, DataInputHistoryResponse, ErrorResponse, GroupParam, HistoryParam1, InlineResponse2004, InlineResponse2005, MachineHistoryResponse) {
  'use strict';
