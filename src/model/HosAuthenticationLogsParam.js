...
(function(root, factory) {
   ...
   * @module model/HosAuthenticationLogsParam
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HosAuthenticationLogsParam</code>.
   * @alias module:model/HosAuthenticationLogsParam
   * @class
   ...
   * @param {module:model/HosAuthenticationLogsParam} obj Optional instance to populate.
   * @return {module:model/HosAuthenticationLogsParam} The populated <code>HosAuthenticationLogsParam</code> instance.
   */
