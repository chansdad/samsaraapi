...
(function(root, factory) {
   ...
   * @module model/HosLogsResponseLogs
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HosLogsResponseLogs</code>.
   * @alias module:model/HosLogsResponseLogs
   * @class
   */
   ...
   * @param {module:model/HosLogsResponseLogs} obj Optional instance to populate.
   * @return {module:model/HosLogsResponseLogs} The populated <code>HosLogsResponseLogs</code> instance.
   */
