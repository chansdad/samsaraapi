...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DvirListResponseMechanicOrAgentSignature = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DvirListResponseMechanicOrAgentSignature model module.
   * @module model/DvirListResponseMechanicOrAgentSignature
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DvirListResponseMechanicOrAgentSignature</code>.
   * The mechanic&#39;s or agent&#39;s signature for the DVIR.
   * @alias module:model/DvirListResponseMechanicOrAgentSignature
   * @class
   */
  ...
  /**
   * Constructs a <code>DvirListResponseMechanicOrAgentSignature</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DvirListResponseMechanicOrAgentSignature} obj Optional instance to populate.
   * @return {module:model/DvirListResponseMechanicOrAgentSignature} The populated <code>DvirListResponseMechanicOrAgentSignature</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('signedAt')) {
        obj['signedAt'] = ApiClient.convertToType(data['signedAt'], 'Number');
      }
    }
    return obj;
  }
   ...
   * @member {Number} signedAt
   */
  exports.prototype['signedAt'] = undefined;
