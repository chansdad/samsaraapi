...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DriversSummaryResponseSummaries = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DriversSummaryResponseSummaries model module.
   * @module model/DriversSummaryResponseSummaries
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DriversSummaryResponseSummaries</code>.
   * @alias module:model/DriversSummaryResponseSummaries
   * @class
   */
  ...
  /**
   * Constructs a <code>DriversSummaryResponseSummaries</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DriversSummaryResponseSummaries} obj Optional instance to populate.
   * @return {module:model/DriversSummaryResponseSummaries} The populated <code>DriversSummaryResponseSummaries</code> instance.
   */
