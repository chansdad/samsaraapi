...
(function(root, factory) {
   ...
   * @module model/VehicleUpdateParam
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VehicleUpdateParam</code>.
   * @alias module:model/VehicleUpdateParam
   * @class
   ...
   * @param {module:model/VehicleUpdateParam} obj Optional instance to populate.
   * @return {module:model/VehicleUpdateParam} The populated <code>VehicleUpdateParam</code> instance.
   */
