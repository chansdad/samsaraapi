...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DataInputHistoryResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DataInputHistoryResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SamsaraApi) {
      root.SamsaraApi = {};
    }
    root.SamsaraApi.InlineResponse2005 = factory(root.SamsaraApi.ApiClient, root.SamsaraApi.DataInputHistoryResponse);
  }
}(this, function(ApiClient, DataInputHistoryResponse) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('dataInputs')) {
        obj['dataInputs'] = ApiClient.convertToType(data['dataInputs'], [DataInputHistoryResponse]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/DataInputHistoryResponse>} dataInputs
   */
  exports.prototype['dataInputs'] = undefined;
