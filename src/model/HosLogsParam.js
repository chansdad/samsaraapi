...
(function(root, factory) {
   ...
   * @module model/HosLogsParam
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HosLogsParam</code>.
   * @alias module:model/HosLogsParam
   * @class
   ...
   * @param {module:model/HosLogsParam} obj Optional instance to populate.
   * @return {module:model/HosLogsParam} The populated <code>HosLogsParam</code> instance.
   */
