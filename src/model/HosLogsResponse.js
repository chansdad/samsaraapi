...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/HosLogsResponseLogs'], factory);
   ...
   * @module model/HosLogsResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HosLogsResponse</code>.
   * @alias module:model/HosLogsResponse
   * @class
   */
   ...
   * @param {module:model/HosLogsResponse} obj Optional instance to populate.
   * @return {module:model/HosLogsResponse} The populated <code>HosLogsResponse</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/HosLogsResponseLogs>} logs
   */
