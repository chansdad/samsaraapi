...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.AssetCable = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The AssetCable model module.
   * @module model/AssetCable
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AssetCable</code>.
   * @alias module:model/AssetCable
   * @class
   */
  ...
  /**
   * Constructs a <code>AssetCable</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AssetCable} obj Optional instance to populate.
   * @return {module:model/AssetCable} The populated <code>AssetCable</code> instance.
   */
