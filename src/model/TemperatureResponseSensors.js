...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.TemperatureResponseSensors = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The TemperatureResponseSensors model module.
   * @module model/TemperatureResponseSensors
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TemperatureResponseSensors</code>.
   * @alias module:model/TemperatureResponseSensors
   * @class
   */
  ...
  /**
   * Constructs a <code>TemperatureResponseSensors</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TemperatureResponseSensors} obj Optional instance to populate.
   * @return {module:model/TemperatureResponseSensors} The populated <code>TemperatureResponseSensors</code> instance.
   */
