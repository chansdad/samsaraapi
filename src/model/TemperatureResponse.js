...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TemperatureResponseSensors'], factory);
   ...
   * @module model/TemperatureResponse
   * @version 1.0.0
   */
   ...
   * @alias module:model/TemperatureResponse
   * @class
   */
   ...
   * @param {module:model/TemperatureResponse} obj Optional instance to populate.
   * @return {module:model/TemperatureResponse} The populated <code>TemperatureResponse</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/TemperatureResponseSensors>} sensors
   */
