...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DriverBase = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DriverBase model module.
   * @module model/DriverBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DriverBase</code>.
   * @alias module:model/DriverBase
   * @class
  ...
  /**
   * Constructs a <code>DriverBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DriverBase} obj Optional instance to populate.
   * @return {module:model/DriverBase} The populated <code>DriverBase</code> instance.
   */
