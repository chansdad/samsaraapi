...
(function(root, factory) {
   ...
   * @module model/HosAuthenticationLogsResponseAuthenticationLogs
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HosAuthenticationLogsResponseAuthenticationLogs</code>.
   * @alias module:model/HosAuthenticationLogsResponseAuthenticationLogs
   * @class
   */
   ...
   * @param {module:model/HosAuthenticationLogsResponseAuthenticationLogs} obj Optional instance to populate.
   * @return {module:model/HosAuthenticationLogsResponseAuthenticationLogs} The populated <code>HosAuthenticationLogsResponseAuthenticationLogs</code> instance.
   */
