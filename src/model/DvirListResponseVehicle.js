...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DvirListResponseVehicle = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DvirListResponseVehicle model module.
   * @module model/DvirListResponseVehicle
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DvirListResponseVehicle</code>.
   * The vehicle on which DVIR was done.
   * @alias module:model/DvirListResponseVehicle
   * @class
   */
  ...
  /**
   * Constructs a <code>DvirListResponseVehicle</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DvirListResponseVehicle} obj Optional instance to populate.
   * @return {module:model/DvirListResponseVehicle} The populated <code>DvirListResponseVehicle</code> instance.
   */
