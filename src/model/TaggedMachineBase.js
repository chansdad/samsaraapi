...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.TaggedMachineBase = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The TaggedMachineBase model module.
   * @module model/TaggedMachineBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TaggedMachineBase</code>.
   * @alias module:model/TaggedMachineBase
   * @class
  ...
  /**
   * Constructs a <code>TaggedMachineBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TaggedMachineBase} obj Optional instance to populate.
   * @return {module:model/TaggedMachineBase} The populated <code>TaggedMachineBase</code> instance.
   */
