...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.HosLogsParam1 = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The HosLogsParam1 model module.
   * @module model/HosLogsParam1
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HosLogsParam1</code>.
   * @alias module:model/HosLogsParam1
   * @class
  ...
  /**
   * Constructs a <code>HosLogsParam1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HosLogsParam1} obj Optional instance to populate.
   * @return {module:model/HosLogsParam1} The populated <code>HosLogsParam1</code> instance.
   */
