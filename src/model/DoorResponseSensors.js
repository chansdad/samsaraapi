...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DoorResponseSensors = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DoorResponseSensors model module.
   * @module model/DoorResponseSensors
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DoorResponseSensors</code>.
   * @alias module:model/DoorResponseSensors
   * @class
   */
  ...
  /**
   * Constructs a <code>DoorResponseSensors</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DoorResponseSensors} obj Optional instance to populate.
   * @return {module:model/DoorResponseSensors} The populated <code>DoorResponseSensors</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('doorClosed')) {
        obj['doorClosed'] = ApiClient.convertToType(data['doorClosed'], 'Boolean');
      }
    }
    return obj;
  }
   ...
   * @member {Boolean} doorClosed
   */
  exports.prototype['doorClosed'] = undefined;
