...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.TaggedSensorBase = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The TaggedSensorBase model module.
   * @module model/TaggedSensorBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TaggedSensorBase</code>.
   * @alias module:model/TaggedSensorBase
   * @class
  ...
  /**
   * Constructs a <code>TaggedSensorBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TaggedSensorBase} obj Optional instance to populate.
   * @return {module:model/TaggedSensorBase} The populated <code>TaggedSensorBase</code> instance.
   */
