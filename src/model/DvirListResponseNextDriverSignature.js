...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DvirListResponseNextDriverSignature = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DvirListResponseNextDriverSignature model module.
   * @module model/DvirListResponseNextDriverSignature
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DvirListResponseNextDriverSignature</code>.
   * The next driver signature for the DVIR.
   * @alias module:model/DvirListResponseNextDriverSignature
   * @class
   */
  ...
  /**
   * Constructs a <code>DvirListResponseNextDriverSignature</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DvirListResponseNextDriverSignature} obj Optional instance to populate.
   * @return {module:model/DvirListResponseNextDriverSignature} The populated <code>DvirListResponseNextDriverSignature</code> instance.
   */
