...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DriverDailyLogResponseSummaries = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DriverDailyLogResponseSummaries model module.
   * @module model/DriverDailyLogResponseSummaries
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DriverDailyLogResponseSummaries</code>.
   * @alias module:model/DriverDailyLogResponseSummaries
   * @class
   */
  ...
  /**
   * Constructs a <code>DriverDailyLogResponseSummaries</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DriverDailyLogResponseSummaries} obj Optional instance to populate.
   * @return {module:model/DriverDailyLogResponseSummaries} The populated <code>DriverDailyLogResponseSummaries</code> instance.
   */
   ...
   */
  exports.prototype['trailerIds'] = undefined;
  /**
