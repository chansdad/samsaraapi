...
(function(root, factory) {
   ...
   * @module model/SensorHistoryResponseResults
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SensorHistoryResponseResults</code>.
   * @alias module:model/SensorHistoryResponseResults
   * @class
   */
   ...
   * @param {module:model/SensorHistoryResponseResults} obj Optional instance to populate.
   * @return {module:model/SensorHistoryResponseResults} The populated <code>SensorHistoryResponseResults</code> instance.
   */
