...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DriversResponseDrivers = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DriversResponseDrivers model module.
   * @module model/DriversResponseDrivers
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DriversResponseDrivers</code>.
   * @alias module:model/DriversResponseDrivers
   * @class
   */
  ...
  /**
   * Constructs a <code>DriversResponseDrivers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DriversResponseDrivers} obj Optional instance to populate.
   * @return {module:model/DriversResponseDrivers} The populated <code>DriversResponseDrivers</code> instance.
   */
