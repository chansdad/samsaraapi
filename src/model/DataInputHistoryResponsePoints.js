...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DataInputHistoryResponsePoints = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DataInputHistoryResponsePoints model module.
   * @module model/DataInputHistoryResponsePoints
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DataInputHistoryResponsePoints</code>.
   * @alias module:model/DataInputHistoryResponsePoints
   * @class
   */
  ...
  /**
   * Constructs a <code>DataInputHistoryResponsePoints</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DataInputHistoryResponsePoints} obj Optional instance to populate.
   * @return {module:model/DataInputHistoryResponsePoints} The populated <code>DataInputHistoryResponsePoints</code> instance.
   */
