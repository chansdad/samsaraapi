...
(function(root, factory) {
   ...
   * @alias module:model/VehicleLocation
   * @class
   ...
   * @param {module:model/VehicleLocation} obj Optional instance to populate.
   * @return {module:model/VehicleLocation} The populated <code>VehicleLocation</code> instance.
   */
