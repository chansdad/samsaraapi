...
(function(root, factory) {
   ...
   * @module model/VehicleMaintenanceJ1939DiagnosticTroubleCodes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>VehicleMaintenanceJ1939DiagnosticTroubleCodes</code>.
   * @alias module:model/VehicleMaintenanceJ1939DiagnosticTroubleCodes
   * @class
   */
   ...
   * @param {module:model/VehicleMaintenanceJ1939DiagnosticTroubleCodes} obj Optional instance to populate.
   * @return {module:model/VehicleMaintenanceJ1939DiagnosticTroubleCodes} The populated <code>VehicleMaintenanceJ1939DiagnosticTroubleCodes</code> instance.
   */
