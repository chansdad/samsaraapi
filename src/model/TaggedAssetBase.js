...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.TaggedAssetBase = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The TaggedAssetBase model module.
   * @module model/TaggedAssetBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TaggedAssetBase</code>.
   * @alias module:model/TaggedAssetBase
   * @class
  ...
  /**
   * Constructs a <code>TaggedAssetBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TaggedAssetBase} obj Optional instance to populate.
   * @return {module:model/TaggedAssetBase} The populated <code>TaggedAssetBase</code> instance.
   */
