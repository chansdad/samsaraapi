...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.AssetLocationResponseInner = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The AssetLocationResponseInner model module.
   * @module model/AssetLocationResponseInner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AssetLocationResponseInner</code>.
   * Asset location details.
   * @alias module:model/AssetLocationResponseInner
   * @class
   */
  ...
  /**
   * Constructs a <code>AssetLocationResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AssetLocationResponseInner} obj Optional instance to populate.
   * @return {module:model/AssetLocationResponseInner} The populated <code>AssetLocationResponseInner</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('speedMilesPerHour')) {
        obj['speedMilesPerHour'] = ApiClient.convertToType(data['speedMilesPerHour'], 'Number');
      }
   ...
   * @member {Number} speedMilesPerHour
   */
  exports.prototype['speedMilesPerHour'] = undefined;
  /**
