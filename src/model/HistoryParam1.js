...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.HistoryParam1 = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The HistoryParam1 model module.
   * @module model/HistoryParam1
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HistoryParam1</code>.
   * @alias module:model/HistoryParam1
   * @class
   ...
   */
  var exports = function(groupId, startMs, endMs) {
    var _this = this;
  ...
  /**
   * Constructs a <code>HistoryParam1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HistoryParam1} obj Optional instance to populate.
   * @return {module:model/HistoryParam1} The populated <code>HistoryParam1</code> instance.
   */
