...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.AssetCurrentLocation = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The AssetCurrentLocation model module.
   * @module model/AssetCurrentLocation
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AssetCurrentLocation</code>.
   * Current location of an asset
   * @alias module:model/AssetCurrentLocation
   * @class
   */
  ...
  /**
   * Constructs a <code>AssetCurrentLocation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AssetCurrentLocation} obj Optional instance to populate.
   * @return {module:model/AssetCurrentLocation} The populated <code>AssetCurrentLocation</code> instance.
   */
