...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SensorHistoryResponseResults'], factory);
   ...
   * @module model/SensorHistoryResponse
   * @version 1.0.0
   */
   ...
   * @alias module:model/SensorHistoryResponse
   * @class
   */
   ...
   * @param {module:model/SensorHistoryResponse} obj Optional instance to populate.
   * @return {module:model/SensorHistoryResponse} The populated <code>SensorHistoryResponse</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/SensorHistoryResponseResults>} results
   */
