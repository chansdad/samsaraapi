...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.TaggedDriverBase = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The TaggedDriverBase model module.
   * @module model/TaggedDriverBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TaggedDriverBase</code>.
   * @alias module:model/TaggedDriverBase
   * @class
  ...
  /**
   * Constructs a <code>TaggedDriverBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TaggedDriverBase} obj Optional instance to populate.
   * @return {module:model/TaggedDriverBase} The populated <code>TaggedDriverBase</code> instance.
   */
