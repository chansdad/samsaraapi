...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.MachineHistoryResponseVibrations = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The MachineHistoryResponseVibrations model module.
   * @module model/MachineHistoryResponseVibrations
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MachineHistoryResponseVibrations</code>.
   * @alias module:model/MachineHistoryResponseVibrations
   * @class
   */
  ...
  /**
   * Constructs a <code>MachineHistoryResponseVibrations</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MachineHistoryResponseVibrations} obj Optional instance to populate.
   * @return {module:model/MachineHistoryResponseVibrations} The populated <code>MachineHistoryResponseVibrations</code> instance.
   */
