...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.TaggedVehicleBase = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The TaggedVehicleBase model module.
   * @module model/TaggedVehicleBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TaggedVehicleBase</code>.
   * @alias module:model/TaggedVehicleBase
   * @class
  ...
  /**
   * Constructs a <code>TaggedVehicleBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TaggedVehicleBase} obj Optional instance to populate.
   * @return {module:model/TaggedVehicleBase} The populated <code>TaggedVehicleBase</code> instance.
   */
