...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AssetCurrentLocationsResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AssetCurrentLocationsResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.SamsaraApi) {
      root.SamsaraApi = {};
    }
    root.SamsaraApi.InlineResponse2008 = factory(root.SamsaraApi.ApiClient, root.SamsaraApi.AssetCurrentLocationsResponse);
  }
}(this, function(ApiClient, AssetCurrentLocationsResponse) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('assets')) {
        obj['assets'] = ApiClient.convertToType(data['assets'], [AssetCurrentLocationsResponse]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/AssetCurrentLocationsResponse>} assets
   */
