...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SensorshistorySeries'], factory);
   ...
   * @module model/HistoryParam
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HistoryParam</code>.
   * @alias module:model/HistoryParam
   * @class
   ...
   * @param series {Array.<module:model/SensorshistorySeries>} 
   */
   ...
   * @param {module:model/HistoryParam} obj Optional instance to populate.
   * @return {module:model/HistoryParam} The populated <code>HistoryParam</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/SensorshistorySeries>} series
   */
  exports.prototype['series'] = undefined;
  /**
   * @member {module:model/HistoryParam.FillMissingEnum} fillMissing
   * @default 'withNull'
   */
