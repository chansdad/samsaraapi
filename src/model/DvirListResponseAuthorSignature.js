...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DvirListResponseAuthorSignature = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DvirListResponseAuthorSignature model module.
   * @module model/DvirListResponseAuthorSignature
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DvirListResponseAuthorSignature</code>.
   * The authors signature for the DVIR.
   * @alias module:model/DvirListResponseAuthorSignature
   * @class
   */
  ...
  /**
   * Constructs a <code>DvirListResponseAuthorSignature</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DvirListResponseAuthorSignature} obj Optional instance to populate.
   * @return {module:model/DvirListResponseAuthorSignature} The populated <code>DvirListResponseAuthorSignature</code> instance.
   */
