...
(function(root, factory) {
   ...
   * @module model/SensorParam
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SensorParam</code>.
   * @alias module:model/SensorParam
   * @class
   ...
   * @param {module:model/SensorParam} obj Optional instance to populate.
   * @return {module:model/SensorParam} The populated <code>SensorParam</code> instance.
   */
