...
(function(root, factory) {
   ...
   * @module model/TripResponseEndCoordinates
   * @version 1.0.0
   */
   ...
   * @alias module:model/TripResponseEndCoordinates
   * @class
   */
   ...
   * @param {module:model/TripResponseEndCoordinates} obj Optional instance to populate.
   * @return {module:model/TripResponseEndCoordinates} The populated <code>TripResponseEndCoordinates</code> instance.
   */
