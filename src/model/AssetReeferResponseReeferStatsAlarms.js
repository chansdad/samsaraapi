...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.AssetReeferResponseReeferStatsAlarms = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The AssetReeferResponseReeferStatsAlarms model module.
   * @module model/AssetReeferResponseReeferStatsAlarms
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AssetReeferResponseReeferStatsAlarms</code>.
   * @alias module:model/AssetReeferResponseReeferStatsAlarms
   * @class
   */
  ...
  /**
   * Constructs a <code>AssetReeferResponseReeferStatsAlarms</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AssetReeferResponseReeferStatsAlarms} obj Optional instance to populate.
   * @return {module:model/AssetReeferResponseReeferStatsAlarms} The populated <code>AssetReeferResponseReeferStatsAlarms</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('alarmCode')) {
        obj['alarmCode'] = ApiClient.convertToType(data['alarmCode'], 'Number');
      }
  ...
  /**
   * ID of the alarm
   * @member {Number} alarmCode
   */
  exports.prototype['alarmCode'] = undefined;
  /**
   ...
   */
  exports.prototype['operatorAction'] = undefined;
