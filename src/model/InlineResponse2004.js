...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Machine'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Machine'));
  } else {
    // Browser globals (root is window)
    if (!root.SamsaraApi) {
      root.SamsaraApi = {};
    }
    root.SamsaraApi.InlineResponse2004 = factory(root.SamsaraApi.ApiClient, root.SamsaraApi.Machine);
  }
}(this, function(ApiClient, Machine) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('machines')) {
        obj['machines'] = ApiClient.convertToType(data['machines'], [Machine]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Machine>} machines
   */
