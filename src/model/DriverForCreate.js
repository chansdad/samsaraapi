...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DriverForCreate = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DriverForCreate model module.
   * @module model/DriverForCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DriverForCreate</code>.
   * @alias module:model/DriverForCreate
   * @class
  ...
  /**
   * Constructs a <code>DriverForCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DriverForCreate} obj Optional instance to populate.
   * @return {module:model/DriverForCreate} The populated <code>DriverForCreate</code> instance.
   */
   ...
   */
  exports.prototype['licenseNumber'] = undefined;
  /**
   * Abbreviation of state that issued driver's license.
   * @member {String} licenseState
   */
  exports.prototype['licenseState'] = undefined;
  /**
   * Flag indicating this driver is exempt from the Electronic Logging Mandate.
   * @member {Boolean} eldExempt
   */
  exports.prototype['eldExempt'] = undefined;
  /**
   * Reason that this driver is exempt from the Electronic Logging Mandate (see eldExempt).
   * @member {String} eldExemptReason
   */
  exports.prototype['eldExemptReason'] = undefined;
  /**
   * Flag indicating this driver may use Big Day excemptions in ELD logs.
   * @member {Boolean} eldBigDayExemptionEnabled
   */
  exports.prototype['eldBigDayExemptionEnabled'] = undefined;
  /**
   * Flag indicating this driver may use Adverse Weather exemptions in ELD logs.
   * @member {Boolean} eldAdverseWeatherExemptionEnabled
   */
  exports.prototype['eldAdverseWeatherExemptionEnabled'] = undefined;
  /**
   * Flag indicating this driver may select the Personal Conveyance duty status in ELD logs.
   * @member {Boolean} eldPcEnabled
   * @default false
   */
  exports.prototype['eldPcEnabled'] = false;
  /**
   * Flag indicating this driver may select the Yard Move duty status in ELD logs.
   * @member {Boolean} eldYmEnabled
   * @default false
   */
  exports.prototype['eldYmEnabled'] = false;
  /**
   * 0 indicating midnight-to-midnight ELD driving hours, 12 to indicate noon-to-noon driving hours.
   * @member {Number} eldDayStartHour
   */
  exports.prototype['eldDayStartHour'] = undefined;
  /**
