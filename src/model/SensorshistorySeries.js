...
(function(root, factory) {
   ...
   * @module model/SensorshistorySeries
   * @version 1.0.0
   */
   ...
   * @alias module:model/SensorshistorySeries
   * @class
   * @param widgetId {Number} Sensor ID to query.
   * @param field {module:model/SensorshistorySeries.FieldEnum} Field to query.
   */
   ...
   * @param {module:model/SensorshistorySeries} obj Optional instance to populate.
   * @return {module:model/SensorshistorySeries} The populated <code>SensorshistorySeries</code> instance.
   */
  ...
  /**
   * Field to query.
   * @member {module:model/SensorshistorySeries.FieldEnum} field
   */
