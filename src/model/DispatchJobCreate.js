...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DispatchJobCreate = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DispatchJobCreate model module.
   * @module model/DispatchJobCreate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DispatchJobCreate</code>.
   * @alias module:model/DispatchJobCreate
   * @class
  ...
  /**
   * Constructs a <code>DispatchJobCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DispatchJobCreate} obj Optional instance to populate.
   * @return {module:model/DispatchJobCreate} The populated <code>DispatchJobCreate</code> instance.
   */
