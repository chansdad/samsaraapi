...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.HosLogsParam2 = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The HosLogsParam2 model module.
   * @module model/HosLogsParam2
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HosLogsParam2</code>.
   * @alias module:model/HosLogsParam2
   * @class
  ...
  /**
   * Constructs a <code>HosLogsParam2</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HosLogsParam2} obj Optional instance to populate.
   * @return {module:model/HosLogsParam2} The populated <code>HosLogsParam2</code> instance.
   */
