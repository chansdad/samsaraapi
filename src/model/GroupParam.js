...
(function(root, factory) {
   ...
   * @module model/GroupParam
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GroupParam</code>.
   * @alias module:model/GroupParam
   * @class
   ...
   * @param {module:model/GroupParam} obj Optional instance to populate.
   * @return {module:model/GroupParam} The populated <code>GroupParam</code> instance.
   */
