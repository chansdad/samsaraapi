...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/VehicleMaintenance'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./VehicleMaintenance'));
  } else {
    // Browser globals (root is window)
    if (!root.SamsaraApi) {
      root.SamsaraApi = {};
    }
    root.SamsaraApi.InlineResponse2003 = factory(root.SamsaraApi.ApiClient, root.SamsaraApi.VehicleMaintenance);
  }
}(this, function(ApiClient, VehicleMaintenance) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('vehicles')) {
        obj['vehicles'] = ApiClient.convertToType(data['vehicles'], [VehicleMaintenance]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/VehicleMaintenance>} vehicles
   */
