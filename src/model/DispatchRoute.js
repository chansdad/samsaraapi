...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.DispatchRoute = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The DispatchRoute model module.
   * @module model/DispatchRoute
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DispatchRoute</code>.
   * @alias module:model/DispatchRoute
   * @class
  ...
  /**
   * Constructs a <code>DispatchRoute</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DispatchRoute} obj Optional instance to populate.
   * @return {module:model/DispatchRoute} The populated <code>DispatchRoute</code> instance.
   */
