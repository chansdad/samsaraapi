...
(function(root, factory) {
   ...
   * @module model/TripResponseStartCoordinates
   * @version 1.0.0
   */
   ...
   * @alias module:model/TripResponseStartCoordinates
   * @class
   */
   ...
   * @param {module:model/TripResponseStartCoordinates} obj Optional instance to populate.
   * @return {module:model/TripResponseStartCoordinates} The populated <code>TripResponseStartCoordinates</code> instance.
   */
