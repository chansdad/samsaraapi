...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.HumidityResponseSensors = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The HumidityResponseSensors model module.
   * @module model/HumidityResponseSensors
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>HumidityResponseSensors</code>.
   * @alias module:model/HumidityResponseSensors
   * @class
   */
  ...
  /**
   * Constructs a <code>HumidityResponseSensors</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HumidityResponseSensors} obj Optional instance to populate.
   * @return {module:model/HumidityResponseSensors} The populated <code>HumidityResponseSensors</code> instance.
   */
