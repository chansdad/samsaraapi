...
(function(root, factory) {
   ...
   * @module model/DriversSummaryParam
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DriversSummaryParam</code>.
   * @alias module:model/DriversSummaryParam
   * @class
   ...
   * @param {module:model/DriversSummaryParam} obj Optional instance to populate.
   * @return {module:model/DriversSummaryParam} The populated <code>DriversSummaryParam</code> instance.
   */
