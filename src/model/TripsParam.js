...
(function(root, factory) {
   ...
   * @module model/TripsParam
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TripsParam</code>.
   * @alias module:model/TripsParam
   * @class
   * @param groupId {Number} Group ID to query.
   * @param vehicleId {Number} Vehicle ID to query.
   * @param startMs {Number} Beginning of the time range, specified in milliseconds UNIX time. Limited to a 90 day window with respect to startMs and endMs
   ...
   * @param {module:model/TripsParam} obj Optional instance to populate.
   * @return {module:model/TripsParam} The populated <code>TripsParam</code> instance.
   */
