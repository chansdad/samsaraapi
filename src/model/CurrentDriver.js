...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SamsaraApi.CurrentDriver = factory(root.SamsaraApi.ApiClient);
  }
  ...
  /**
   * The CurrentDriver model module.
   * @module model/CurrentDriver
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CurrentDriver</code>.
   * @alias module:model/CurrentDriver
   * @class
   */
  ...
  /**
   * Constructs a <code>CurrentDriver</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CurrentDriver} obj Optional instance to populate.
   * @return {module:model/CurrentDriver} The populated <code>CurrentDriver</code> instance.
   */
