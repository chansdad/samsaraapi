...
(function(root, factory) {
   ...
   * @module model/GroupDriversParam
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GroupDriversParam</code>.
   * @alias module:model/GroupDriversParam
   * @class
   ...
   * @param {module:model/GroupDriversParam} obj Optional instance to populate.
   * @return {module:model/GroupDriversParam} The populated <code>GroupDriversParam</code> instance.
   */
