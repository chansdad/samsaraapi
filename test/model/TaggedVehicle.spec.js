...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TaggedVehicle();
  });
  ...
  describe('TaggedVehicle', function() {
    it('should create an instance of TaggedVehicle', function() {
      // uncomment below and update the code to test TaggedVehicle
      //var instance = new SamsaraApi.TaggedVehicle();
      //expect(instance).to.be.a(SamsaraApi.TaggedVehicle);
    });
