...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DvirListResponseVehicleDefects();
  });
  ...
  describe('DvirListResponseVehicleDefects', function() {
    it('should create an instance of DvirListResponseVehicleDefects', function() {
      // uncomment below and update the code to test DvirListResponseVehicleDefects
      //var instance = new SamsaraApi.DvirListResponseVehicleDefects();
      //expect(instance).to.be.a(SamsaraApi.DvirListResponseVehicleDefects);
    });

    it('should have the property defectType (base name: "defectType")', function() {
      // uncomment below and update the code to test the property defectType
      //var instance = new SamsaraApi.DvirListResponseVehicleDefects();
