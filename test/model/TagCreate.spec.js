...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TagCreate();
  });
  ...
  describe('TagCreate', function() {
    it('should create an instance of TagCreate', function() {
      // uncomment below and update the code to test TagCreate
      //var instance = new SamsaraApi.TagCreate();
      //expect(instance).to.be.a(SamsaraApi.TagCreate);
    });
