...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.Vehicle();
  });
  ...
  describe('Vehicle', function() {
    it('should create an instance of Vehicle', function() {
      ...
      //var instance = new SamsaraApi.Vehicle();
      //expect(instance).to.be.a(SamsaraApi.Vehicle);
    });
    ...
    it('should have the property odometerMeters (base name: "odometerMeters")', function() {
      // uncomment below and update the code to test the property odometerMeters
      //var instance = new SamsaraApi.Vehicle();
      //expect(instance).to.be();
    });
