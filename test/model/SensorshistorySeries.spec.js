...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.SensorshistorySeries();
  });
  ...
  describe('SensorshistorySeries', function() {
    it('should create an instance of SensorshistorySeries', function() {
      // uncomment below and update the code to test SensorshistorySeries
      //var instance = new SamsaraApi.SensorshistorySeries();
      //expect(instance).to.be.a(SamsaraApi.SensorshistorySeries);
    });

    it('should have the property widgetId (base name: "widgetId")', function() {
      // uncomment below and update the code to test the property widgetId
      //var instance = new SamsaraApi.SensorshistorySeries();
