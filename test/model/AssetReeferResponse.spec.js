...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AssetReeferResponse();
  });
  ...
  describe('AssetReeferResponse', function() {
    it('should create an instance of AssetReeferResponse', function() {
      // uncomment below and update the code to test AssetReeferResponse
      //var instance = new SamsaraApi.AssetReeferResponse();
      //expect(instance).to.be.a(SamsaraApi.AssetReeferResponse);
    });
    ...
    it('should have the property reeferStats (base name: "reeferStats")', function() {
      // uncomment below and update the code to test the property reeferStats
      //var instance = new SamsaraApi.AssetReeferResponse();
      //expect(instance).to.be();
    });
