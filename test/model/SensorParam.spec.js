...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.SensorParam();
  });
  ...
  describe('SensorParam', function() {
    it('should create an instance of SensorParam', function() {
      // uncomment below and update the code to test SensorParam
      //var instance = new SamsaraApi.SensorParam();
      //expect(instance).to.be.a(SamsaraApi.SensorParam);
    });
