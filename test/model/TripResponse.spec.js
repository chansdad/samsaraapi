...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TripResponse();
  });
  ...
  describe('TripResponse', function() {
    it('should create an instance of TripResponse', function() {
      // uncomment below and update the code to test TripResponse
      //var instance = new SamsaraApi.TripResponse();
      //expect(instance).to.be.a(SamsaraApi.TripResponse);
    });
