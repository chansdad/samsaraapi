...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DvirListResponse();
  });
  ...
  describe('DvirListResponse', function() {
    it('should create an instance of DvirListResponse', function() {
      // uncomment below and update the code to test DvirListResponse
      //var instance = new SamsaraApi.DvirListResponse();
      //expect(instance).to.be.a(SamsaraApi.DvirListResponse);
    });

    it('should have the property dvirs (base name: "dvirs")', function() {
      // uncomment below and update the code to test the property dvirs
      //var instance = new SamsaraApi.DvirListResponse();
