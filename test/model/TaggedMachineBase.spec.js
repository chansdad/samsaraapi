...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TaggedMachineBase();
  });
  ...
  describe('TaggedMachineBase', function() {
    it('should create an instance of TaggedMachineBase', function() {
      // uncomment below and update the code to test TaggedMachineBase
      //var instance = new SamsaraApi.TaggedMachineBase();
      //expect(instance).to.be.a(SamsaraApi.TaggedMachineBase);
    });
