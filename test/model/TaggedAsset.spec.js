...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TaggedAsset();
  });
  ...
  describe('TaggedAsset', function() {
    it('should create an instance of TaggedAsset', function() {
      // uncomment below and update the code to test TaggedAsset
      //var instance = new SamsaraApi.TaggedAsset();
      //expect(instance).to.be.a(SamsaraApi.TaggedAsset);
    });
