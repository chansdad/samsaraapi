...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.MachineHistoryResponse();
  });
  ...
  describe('MachineHistoryResponse', function() {
    it('should create an instance of MachineHistoryResponse', function() {
      // uncomment below and update the code to test MachineHistoryResponse
      //var instance = new SamsaraApi.MachineHistoryResponse();
      //expect(instance).to.be.a(SamsaraApi.MachineHistoryResponse);
    });
