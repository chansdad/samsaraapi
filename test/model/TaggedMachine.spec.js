...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TaggedMachine();
  });
  ...
  describe('TaggedMachine', function() {
    it('should create an instance of TaggedMachine', function() {
      // uncomment below and update the code to test TaggedMachine
      //var instance = new SamsaraApi.TaggedMachine();
      //expect(instance).to.be.a(SamsaraApi.TaggedMachine);
    });
