...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TemperatureResponse();
  });
  ...
  describe('TemperatureResponse', function() {
    it('should create an instance of TemperatureResponse', function() {
      // uncomment below and update the code to test TemperatureResponse
      //var instance = new SamsaraApi.TemperatureResponse();
      //expect(instance).to.be.a(SamsaraApi.TemperatureResponse);
    });
