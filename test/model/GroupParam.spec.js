...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.GroupParam();
  });
  ...
  describe('GroupParam', function() {
    it('should create an instance of GroupParam', function() {
      // uncomment below and update the code to test GroupParam
      //var instance = new SamsaraApi.GroupParam();
      //expect(instance).to.be.a(SamsaraApi.GroupParam);
    });
