...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TaggedDriverBase();
  });
  ...
  describe('TaggedDriverBase', function() {
    it('should create an instance of TaggedDriverBase', function() {
      // uncomment below and update the code to test TaggedDriverBase
      //var instance = new SamsaraApi.TaggedDriverBase();
      //expect(instance).to.be.a(SamsaraApi.TaggedDriverBase);
    });
