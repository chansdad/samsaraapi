...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TaggedSensor();
  });
  ...
  describe('TaggedSensor', function() {
    it('should create an instance of TaggedSensor', function() {
      // uncomment below and update the code to test TaggedSensor
      //var instance = new SamsaraApi.TaggedSensor();
      //expect(instance).to.be.a(SamsaraApi.TaggedSensor);
    });
