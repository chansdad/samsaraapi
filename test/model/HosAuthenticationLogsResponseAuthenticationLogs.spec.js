...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.HosAuthenticationLogsResponseAuthenticationLogs();
  });
  ...
  describe('HosAuthenticationLogsResponseAuthenticationLogs', function() {
    it('should create an instance of HosAuthenticationLogsResponseAuthenticationLogs', function() {
      // uncomment below and update the code to test HosAuthenticationLogsResponseAuthenticationLogs
      //var instance = new SamsaraApi.HosAuthenticationLogsResponseAuthenticationLogs();
      //expect(instance).to.be.a(SamsaraApi.HosAuthenticationLogsResponseAuthenticationLogs);
    });
    ...
    it('should have the property happenedAtMs (base name: "happenedAtMs")', function() {
      // uncomment below and update the code to test the property happenedAtMs
      //var instance = new SamsaraApi.HosAuthenticationLogsResponseAuthenticationLogs();
      //expect(instance).to.be();
    });
