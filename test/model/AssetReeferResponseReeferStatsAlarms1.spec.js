...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AssetReeferResponseReeferStatsAlarms1();
  });
  ...
  describe('AssetReeferResponseReeferStatsAlarms1', function() {
    it('should create an instance of AssetReeferResponseReeferStatsAlarms1', function() {
      // uncomment below and update the code to test AssetReeferResponseReeferStatsAlarms1
      //var instance = new SamsaraApi.AssetReeferResponseReeferStatsAlarms1();
      //expect(instance).to.be.a(SamsaraApi.AssetReeferResponseReeferStatsAlarms1);
    });
