...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DispatchRoutes();
  });
  ...
  describe('DispatchRoutes', function() {
    it('should create an instance of DispatchRoutes', function() {
      // uncomment below and update the code to test DispatchRoutes
      //var instance = new SamsaraApi.DispatchRoutes();
      //expect(instance).to.be.a(SamsaraApi.DispatchRoutes);
    });
