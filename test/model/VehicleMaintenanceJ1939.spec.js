...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.VehicleMaintenanceJ1939();
  });
  ...
  describe('VehicleMaintenanceJ1939', function() {
    it('should create an instance of VehicleMaintenanceJ1939', function() {
      // uncomment below and update the code to test VehicleMaintenanceJ1939
      //var instance = new SamsaraApi.VehicleMaintenanceJ1939();
      //expect(instance).to.be.a(SamsaraApi.VehicleMaintenanceJ1939);
    });
