...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DvirListResponseNextDriverSignature();
  });
  ...
  describe('DvirListResponseNextDriverSignature', function() {
    it('should create an instance of DvirListResponseNextDriverSignature', function() {
      // uncomment below and update the code to test DvirListResponseNextDriverSignature
      //var instance = new SamsaraApi.DvirListResponseNextDriverSignature();
      //expect(instance).to.be.a(SamsaraApi.DvirListResponseNextDriverSignature);
    });
