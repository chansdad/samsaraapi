...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DriverDailyLogResponse();
  });
  ...
  describe('DriverDailyLogResponse', function() {
    it('should create an instance of DriverDailyLogResponse', function() {
      // uncomment below and update the code to test DriverDailyLogResponse
      //var instance = new SamsaraApi.DriverDailyLogResponse();
      //expect(instance).to.be.a(SamsaraApi.DriverDailyLogResponse);
    });
