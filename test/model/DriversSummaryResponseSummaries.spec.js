...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DriversSummaryResponseSummaries();
  });
  ...
  describe('DriversSummaryResponseSummaries', function() {
    it('should create an instance of DriversSummaryResponseSummaries', function() {
      // uncomment below and update the code to test DriversSummaryResponseSummaries
      //var instance = new SamsaraApi.DriversSummaryResponseSummaries();
      //expect(instance).to.be.a(SamsaraApi.DriversSummaryResponseSummaries);
    });
    ...
    it('should have the property driverUsername (base name: "driverUsername")', function() {
      // uncomment below and update the code to test the property driverUsername
      //var instance = new SamsaraApi.DriversSummaryResponseSummaries();
      //expect(instance).to.be();
    });
