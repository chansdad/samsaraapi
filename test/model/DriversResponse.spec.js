...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DriversResponse();
  });
  ...
  describe('DriversResponse', function() {
    it('should create an instance of DriversResponse', function() {
      // uncomment below and update the code to test DriversResponse
      //var instance = new SamsaraApi.DriversResponse();
      //expect(instance).to.be.a(SamsaraApi.DriversResponse);
    });
