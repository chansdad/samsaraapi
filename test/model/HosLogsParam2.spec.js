...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.HosLogsParam2();
  });
  ...
  describe('HosLogsParam2', function() {
    it('should create an instance of HosLogsParam2', function() {
      // uncomment below and update the code to test HosLogsParam2
      //var instance = new SamsaraApi.HosLogsParam2();
      //expect(instance).to.be.a(SamsaraApi.HosLogsParam2);
    });
