...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.HumidityResponseSensors();
  });
  ...
  describe('HumidityResponseSensors', function() {
    it('should create an instance of HumidityResponseSensors', function() {
      // uncomment below and update the code to test HumidityResponseSensors
      //var instance = new SamsaraApi.HumidityResponseSensors();
      //expect(instance).to.be.a(SamsaraApi.HumidityResponseSensors);
    });
