...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TaggedVehicleBase();
  });
  ...
  describe('TaggedVehicleBase', function() {
    it('should create an instance of TaggedVehicleBase', function() {
      // uncomment below and update the code to test TaggedVehicleBase
      //var instance = new SamsaraApi.TaggedVehicleBase();
      //expect(instance).to.be.a(SamsaraApi.TaggedVehicleBase);
    });
