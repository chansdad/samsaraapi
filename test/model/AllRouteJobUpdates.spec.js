...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AllRouteJobUpdates();
  });
  ...
  describe('AllRouteJobUpdates', function() {
    it('should create an instance of AllRouteJobUpdates', function() {
      // uncomment below and update the code to test AllRouteJobUpdates
      //var instance = new SamsaraApi.AllRouteJobUpdates();
      //expect(instance).to.be.a(SamsaraApi.AllRouteJobUpdates);
    });

    it('should have the property jobUpdates (base name: "job_updates")', function() {
      // uncomment below and update the code to test the property jobUpdates
      //var instance = new SamsaraApi.AllRouteJobUpdates();
      //expect(instance).to.be();
    });

    it('should have the property sequenceId (base name: "sequence_id")', function() {
