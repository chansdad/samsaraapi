...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TaggedAssetBase();
  });
  ...
  describe('TaggedAssetBase', function() {
    it('should create an instance of TaggedAssetBase', function() {
      // uncomment below and update the code to test TaggedAssetBase
      //var instance = new SamsaraApi.TaggedAssetBase();
      //expect(instance).to.be.a(SamsaraApi.TaggedAssetBase);
    });
