...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DriversSummaryParam();
  });
  ...
  describe('DriversSummaryParam', function() {
    it('should create an instance of DriversSummaryParam', function() {
      // uncomment below and update the code to test DriversSummaryParam
      //var instance = new SamsaraApi.DriversSummaryParam();
      //expect(instance).to.be.a(SamsaraApi.DriversSummaryParam);
    });
