...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AssetReeferResponseReeferStatsAlarms();
  });
  ...
  describe('AssetReeferResponseReeferStatsAlarms', function() {
    it('should create an instance of AssetReeferResponseReeferStatsAlarms', function() {
      // uncomment below and update the code to test AssetReeferResponseReeferStatsAlarms
      //var instance = new SamsaraApi.AssetReeferResponseReeferStatsAlarms();
      //expect(instance).to.be.a(SamsaraApi.AssetReeferResponseReeferStatsAlarms);
    });

    it('should have the property alarmCode (base name: "alarmCode")', function() {
      // uncomment below and update the code to test the property alarmCode
      //var instance = new SamsaraApi.AssetReeferResponseReeferStatsAlarms();
