...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DispatchRouteHistoricalEntry();
  });
  ...
  describe('DispatchRouteHistoricalEntry', function() {
    it('should create an instance of DispatchRouteHistoricalEntry', function() {
      // uncomment below and update the code to test DispatchRouteHistoricalEntry
      //var instance = new SamsaraApi.DispatchRouteHistoricalEntry();
      //expect(instance).to.be.a(SamsaraApi.DispatchRouteHistoricalEntry);
    });
