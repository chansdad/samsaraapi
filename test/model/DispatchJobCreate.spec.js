...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DispatchJobCreate();
  });
  ...
  describe('DispatchJobCreate', function() {
    it('should create an instance of DispatchJobCreate', function() {
      // uncomment below and update the code to test DispatchJobCreate
      //var instance = new SamsaraApi.DispatchJobCreate();
      //expect(instance).to.be.a(SamsaraApi.DispatchJobCreate);
    });
