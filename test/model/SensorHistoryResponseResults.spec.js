...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.SensorHistoryResponseResults();
  });
  ...
  describe('SensorHistoryResponseResults', function() {
    it('should create an instance of SensorHistoryResponseResults', function() {
      // uncomment below and update the code to test SensorHistoryResponseResults
      //var instance = new SamsaraApi.SensorHistoryResponseResults();
      //expect(instance).to.be.a(SamsaraApi.SensorHistoryResponseResults);
    });
