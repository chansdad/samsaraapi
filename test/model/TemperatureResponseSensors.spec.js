...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TemperatureResponseSensors();
  });
  ...
  describe('TemperatureResponseSensors', function() {
    it('should create an instance of TemperatureResponseSensors', function() {
      // uncomment below and update the code to test TemperatureResponseSensors
      //var instance = new SamsaraApi.TemperatureResponseSensors();
      //expect(instance).to.be.a(SamsaraApi.TemperatureResponseSensors);
    });
    ...
    it('should have the property ambientTemperature (base name: "ambientTemperature")', function() {
      // uncomment below and update the code to test the property ambientTemperature
      //var instance = new SamsaraApi.TemperatureResponseSensors();
      //expect(instance).to.be();
    });

    it('should have the property probeTemperature (base name: "probeTemperature")', function() {
      // uncomment below and update the code to test the property probeTemperature
      //var instance = new SamsaraApi.TemperatureResponseSensors();
      //expect(instance).to.be();
    });
