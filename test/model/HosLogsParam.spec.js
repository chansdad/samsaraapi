...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.HosLogsParam();
  });
  ...
  describe('HosLogsParam', function() {
    it('should create an instance of HosLogsParam', function() {
      // uncomment below and update the code to test HosLogsParam
      //var instance = new SamsaraApi.HosLogsParam();
      //expect(instance).to.be.a(SamsaraApi.HosLogsParam);
    });
