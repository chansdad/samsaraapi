...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TaggedDriver();
  });
  ...
  describe('TaggedDriver', function() {
    it('should create an instance of TaggedDriver', function() {
      // uncomment below and update the code to test TaggedDriver
      //var instance = new SamsaraApi.TaggedDriver();
      //expect(instance).to.be.a(SamsaraApi.TaggedDriver);
    });
