...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.JobUpdateObject();
  });
  ...
  describe('JobUpdateObject', function() {
    it('should create an instance of JobUpdateObject', function() {
      // uncomment below and update the code to test JobUpdateObject
      //var instance = new SamsaraApi.JobUpdateObject();
      //expect(instance).to.be.a(SamsaraApi.JobUpdateObject);
    });

    it('should have the property changedAtMs (base name: "changed_at_ms")', function() {
    ...
    it('should have the property prevJobState (base name: "prev_job_state")', function() {
      // uncomment below and update the code to test the property prevJobState
      //var instance = new SamsaraApi.JobUpdateObject();
      //expect(instance).to.be();
    });
