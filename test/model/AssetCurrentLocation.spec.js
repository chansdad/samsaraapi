...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AssetCurrentLocation();
  });
  ...
  describe('AssetCurrentLocation', function() {
    it('should create an instance of AssetCurrentLocation', function() {
      // uncomment below and update the code to test AssetCurrentLocation
      //var instance = new SamsaraApi.AssetCurrentLocation();
      //expect(instance).to.be.a(SamsaraApi.AssetCurrentLocation);
    });
