...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DriversResponseDrivers();
  });
  ...
  describe('DriversResponseDrivers', function() {
    it('should create an instance of DriversResponseDrivers', function() {
      // uncomment below and update the code to test DriversResponseDrivers
      //var instance = new SamsaraApi.DriversResponseDrivers();
      //expect(instance).to.be.a(SamsaraApi.DriversResponseDrivers);
    });
