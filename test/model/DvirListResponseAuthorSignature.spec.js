...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DvirListResponseAuthorSignature();
  });
  ...
  describe('DvirListResponseAuthorSignature', function() {
    it('should create an instance of DvirListResponseAuthorSignature', function() {
      // uncomment below and update the code to test DvirListResponseAuthorSignature
      //var instance = new SamsaraApi.DvirListResponseAuthorSignature();
      //expect(instance).to.be.a(SamsaraApi.DvirListResponseAuthorSignature);
    });
