...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DispatchJob();
  });
  ...
  describe('DispatchJob', function() {
    it('should create an instance of DispatchJob', function() {
      // uncomment below and update the code to test DispatchJob
      //var instance = new SamsaraApi.DispatchJob();
      //expect(instance).to.be.a(SamsaraApi.DispatchJob);
    });
