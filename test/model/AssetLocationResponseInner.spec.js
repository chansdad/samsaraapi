...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AssetLocationResponseInner();
  });
  ...
  describe('AssetLocationResponseInner', function() {
    it('should create an instance of AssetLocationResponseInner', function() {
      // uncomment below and update the code to test AssetLocationResponseInner
      //var instance = new SamsaraApi.AssetLocationResponseInner();
      //expect(instance).to.be.a(SamsaraApi.AssetLocationResponseInner);
    });
    ...
    it('should have the property speedMilesPerHour (base name: "speedMilesPerHour")', function() {
      // uncomment below and update the code to test the property speedMilesPerHour
      //var instance = new SamsaraApi.AssetLocationResponseInner();
      //expect(instance).to.be();
    });
