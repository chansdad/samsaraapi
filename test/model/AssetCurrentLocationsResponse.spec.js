...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AssetCurrentLocationsResponse();
  });
  ...
  describe('AssetCurrentLocationsResponse', function() {
    it('should create an instance of AssetCurrentLocationsResponse', function() {
      // uncomment below and update the code to test AssetCurrentLocationsResponse
      //var instance = new SamsaraApi.AssetCurrentLocationsResponse();
      //expect(instance).to.be.a(SamsaraApi.AssetCurrentLocationsResponse);
    });
