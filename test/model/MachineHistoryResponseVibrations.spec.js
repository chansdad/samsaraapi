...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.MachineHistoryResponseVibrations();
  });
  ...
  describe('MachineHistoryResponseVibrations', function() {
    it('should create an instance of MachineHistoryResponseVibrations', function() {
      // uncomment below and update the code to test MachineHistoryResponseVibrations
      //var instance = new SamsaraApi.MachineHistoryResponseVibrations();
      //expect(instance).to.be.a(SamsaraApi.MachineHistoryResponseVibrations);
    });
