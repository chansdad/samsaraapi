...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.HistoryParam1();
  });
  ...
  describe('HistoryParam1', function() {
    it('should create an instance of HistoryParam1', function() {
      // uncomment below and update the code to test HistoryParam1
      //var instance = new SamsaraApi.HistoryParam1();
      //expect(instance).to.be.a(SamsaraApi.HistoryParam1);
    });
