...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.Machine();
  });
  ...
  describe('Machine', function() {
    it('should create an instance of Machine', function() {
      // uncomment below and update the code to test Machine
      //var instance = new SamsaraApi.Machine();
      //expect(instance).to.be.a(SamsaraApi.Machine);
    });
