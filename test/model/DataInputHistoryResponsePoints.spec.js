...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DataInputHistoryResponsePoints();
  });
  ...
  describe('DataInputHistoryResponsePoints', function() {
    it('should create an instance of DataInputHistoryResponsePoints', function() {
      // uncomment below and update the code to test DataInputHistoryResponsePoints
      //var instance = new SamsaraApi.DataInputHistoryResponsePoints();
      //expect(instance).to.be.a(SamsaraApi.DataInputHistoryResponsePoints);
    });
