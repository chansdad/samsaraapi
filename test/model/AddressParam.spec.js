...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AddressParam();
  });
  ...
  describe('AddressParam', function() {
    it('should create an instance of AddressParam', function() {
      // uncomment below and update the code to test AddressParam
      //var instance = new SamsaraApi.AddressParam();
      //expect(instance).to.be.a(SamsaraApi.AddressParam);
    });
