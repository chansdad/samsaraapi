...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AssetCable();
  });
  ...
  describe('AssetCable', function() {
    it('should create an instance of AssetCable', function() {
      // uncomment below and update the code to test AssetCable
      //var instance = new SamsaraApi.AssetCable();
      //expect(instance).to.be.a(SamsaraApi.AssetCable);
    });
