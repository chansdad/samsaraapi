...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.HosAuthenticationLogsResponse();
  });
  ...
  describe('HosAuthenticationLogsResponse', function() {
    it('should create an instance of HosAuthenticationLogsResponse', function() {
      // uncomment below and update the code to test HosAuthenticationLogsResponse
      //var instance = new SamsaraApi.HosAuthenticationLogsResponse();
      //expect(instance).to.be.a(SamsaraApi.HosAuthenticationLogsResponse);
    });

    it('should have the property authenticationLogs (base name: "authenticationLogs")', function() {
      // uncomment below and update the code to test the property authenticationLogs
      //var instance = new SamsaraApi.HosAuthenticationLogsResponse();
