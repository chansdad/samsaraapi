...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.VehicleUpdateParam();
  });
  ...
  describe('VehicleUpdateParam', function() {
    it('should create an instance of VehicleUpdateParam', function() {
      // uncomment below and update the code to test VehicleUpdateParam
      //var instance = new SamsaraApi.VehicleUpdateParam();
      //expect(instance).to.be.a(SamsaraApi.VehicleUpdateParam);
    });
