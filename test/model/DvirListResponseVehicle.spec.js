...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DvirListResponseVehicle();
  });
  ...
  describe('DvirListResponseVehicle', function() {
    it('should create an instance of DvirListResponseVehicle', function() {
      // uncomment below and update the code to test DvirListResponseVehicle
      //var instance = new SamsaraApi.DvirListResponseVehicle();
      //expect(instance).to.be.a(SamsaraApi.DvirListResponseVehicle);
    });
