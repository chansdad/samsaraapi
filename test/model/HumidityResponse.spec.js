...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.HumidityResponse();
  });
  ...
  describe('HumidityResponse', function() {
    it('should create an instance of HumidityResponse', function() {
      // uncomment below and update the code to test HumidityResponse
      //var instance = new SamsaraApi.HumidityResponse();
      //expect(instance).to.be.a(SamsaraApi.HumidityResponse);
    });
