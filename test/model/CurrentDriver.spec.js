...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.CurrentDriver();
  });
  ...
  describe('CurrentDriver', function() {
    it('should create an instance of CurrentDriver', function() {
      // uncomment below and update the code to test CurrentDriver
      //var instance = new SamsaraApi.CurrentDriver();
      //expect(instance).to.be.a(SamsaraApi.CurrentDriver);
    });
