...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.MachineHistoryResponseMachines();
  });
  ...
  describe('MachineHistoryResponseMachines', function() {
    it('should create an instance of MachineHistoryResponseMachines', function() {
      // uncomment below and update the code to test MachineHistoryResponseMachines
      //var instance = new SamsaraApi.MachineHistoryResponseMachines();
      //expect(instance).to.be.a(SamsaraApi.MachineHistoryResponseMachines);
    });
    ...
    it('should have the property vibrations (base name: "vibrations")', function() {
      // uncomment below and update the code to test the property vibrations
      //var instance = new SamsaraApi.MachineHistoryResponseMachines();
      //expect(instance).to.be();
    });
