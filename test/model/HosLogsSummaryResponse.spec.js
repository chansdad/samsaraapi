...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.HosLogsSummaryResponse();
  });
  ...
  describe('HosLogsSummaryResponse', function() {
    it('should create an instance of HosLogsSummaryResponse', function() {
      // uncomment below and update the code to test HosLogsSummaryResponse
      //var instance = new SamsaraApi.HosLogsSummaryResponse();
      //expect(instance).to.be.a(SamsaraApi.HosLogsSummaryResponse);
    });
