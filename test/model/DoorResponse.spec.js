...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DoorResponse();
  });
  ...
  describe('DoorResponse', function() {
    it('should create an instance of DoorResponse', function() {
      // uncomment below and update the code to test DoorResponse
      //var instance = new SamsaraApi.DoorResponse();
      //expect(instance).to.be.a(SamsaraApi.DoorResponse);
    });
