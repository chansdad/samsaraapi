...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.CargoResponseSensors();
  });
  ...
  describe('CargoResponseSensors', function() {
    it('should create an instance of CargoResponseSensors', function() {
      // uncomment below and update the code to test CargoResponseSensors
      //var instance = new SamsaraApi.CargoResponseSensors();
      //expect(instance).to.be.a(SamsaraApi.CargoResponseSensors);
    });
    ...
    it('should have the property cargoEmpty (base name: "cargoEmpty")', function() {
      // uncomment below and update the code to test the property cargoEmpty
      //var instance = new SamsaraApi.CargoResponseSensors();
      //expect(instance).to.be();
    });
