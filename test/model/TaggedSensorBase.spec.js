...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TaggedSensorBase();
  });
  ...
  describe('TaggedSensorBase', function() {
    it('should create an instance of TaggedSensorBase', function() {
      // uncomment below and update the code to test TaggedSensorBase
      //var instance = new SamsaraApi.TaggedSensorBase();
      //expect(instance).to.be.a(SamsaraApi.TaggedSensorBase);
    });
