...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DoorResponseSensors();
  });
  ...
  describe('DoorResponseSensors', function() {
    it('should create an instance of DoorResponseSensors', function() {
      // uncomment below and update the code to test DoorResponseSensors
      //var instance = new SamsaraApi.DoorResponseSensors();
      //expect(instance).to.be.a(SamsaraApi.DoorResponseSensors);
    });
    ...
    it('should have the property doorClosed (base name: "doorClosed")', function() {
      // uncomment below and update the code to test the property doorClosed
      //var instance = new SamsaraApi.DoorResponseSensors();
      //expect(instance).to.be();
    });
