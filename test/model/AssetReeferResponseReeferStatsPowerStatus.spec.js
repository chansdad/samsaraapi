...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AssetReeferResponseReeferStatsPowerStatus();
  });
  ...
  describe('AssetReeferResponseReeferStatsPowerStatus', function() {
    it('should create an instance of AssetReeferResponseReeferStatsPowerStatus', function() {
      // uncomment below and update the code to test AssetReeferResponseReeferStatsPowerStatus
      //var instance = new SamsaraApi.AssetReeferResponseReeferStatsPowerStatus();
      //expect(instance).to.be.a(SamsaraApi.AssetReeferResponseReeferStatsPowerStatus);
    });
