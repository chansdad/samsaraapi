...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.CargoResponse();
  });
  ...
  describe('CargoResponse', function() {
    it('should create an instance of CargoResponse', function() {
      // uncomment below and update the code to test CargoResponse
      //var instance = new SamsaraApi.CargoResponse();
      //expect(instance).to.be.a(SamsaraApi.CargoResponse);
    });
