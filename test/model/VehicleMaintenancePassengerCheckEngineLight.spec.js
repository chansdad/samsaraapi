...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.VehicleMaintenancePassengerCheckEngineLight();
  });
  ...
  describe('VehicleMaintenancePassengerCheckEngineLight', function() {
    it('should create an instance of VehicleMaintenancePassengerCheckEngineLight', function() {
      // uncomment below and update the code to test VehicleMaintenancePassengerCheckEngineLight
      //var instance = new SamsaraApi.VehicleMaintenancePassengerCheckEngineLight();
      //expect(instance).to.be.a(SamsaraApi.VehicleMaintenancePassengerCheckEngineLight);
    });
