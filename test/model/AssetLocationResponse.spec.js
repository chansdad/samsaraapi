...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.AssetLocationResponse();
  });
  ...
  describe('AssetLocationResponse', function() {
    it('should create an instance of AssetLocationResponse', function() {
      // uncomment below and update the code to test AssetLocationResponse
      //var instance = new SamsaraApi.AssetLocationResponse();
      //expect(instance).to.be.a(SamsaraApi.AssetLocationResponse);
    });
