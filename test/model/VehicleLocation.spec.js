...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.VehicleLocation();
  });
  ...
  describe('VehicleLocation', function() {
    it('should create an instance of VehicleLocation', function() {
      // uncomment below and update the code to test VehicleLocation
      //var instance = new SamsaraApi.VehicleLocation();
      //expect(instance).to.be.a(SamsaraApi.VehicleLocation);
    });
    ...
    it('should have the property onTrip (base name: "onTrip")', function() {
      // uncomment below and update the code to test the property onTrip
      //var instance = new SamsaraApi.VehicleLocation();
      //expect(instance).to.be();
    });
