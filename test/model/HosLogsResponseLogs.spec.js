...
(function(root, factory) {
  ...
  describe('HosLogsResponseLogs', function() {
    it('should create an instance of HosLogsResponseLogs', function() {
      ...
      //var instance = new SamsaraApi.HosLogsResponseLogs();
    ...
    it('should have the property locName (base name: "locName")', function() {
      // uncomment below and update the code to test the property locName
      //var instance = new SamsaraApi.HosLogsResponseLogs();
      //expect(instance).to.be();
    });
