...
(function(root, factory) {
  ...
  describe('PrevJobStatus', function() {
    it('should create an instance of PrevJobStatus', function() {
      // uncomment below and update the code to test PrevJobStatus
      //var instance = new SamsaraApi.PrevJobStatus();
      //expect(instance).to.be.a(SamsaraApi.PrevJobStatus);
    });
