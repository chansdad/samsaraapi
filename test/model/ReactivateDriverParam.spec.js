...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.ReactivateDriverParam();
  });
  ...
  describe('ReactivateDriverParam', function() {
    it('should create an instance of ReactivateDriverParam', function() {
      // uncomment below and update the code to test ReactivateDriverParam
      //var instance = new SamsaraApi.ReactivateDriverParam();
      //expect(instance).to.be.a(SamsaraApi.ReactivateDriverParam);
    });

    it('should have the property reactivate (base name: "reactivate")', function() {
      // uncomment below and update the code to test the property reactivate
      //var instance = new SamsaraApi.ReactivateDriverParam();
