...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.HosLogsParam1();
  });
  ...
  describe('HosLogsParam1', function() {
    it('should create an instance of HosLogsParam1', function() {
      // uncomment below and update the code to test HosLogsParam1
      //var instance = new SamsaraApi.HosLogsParam1();
      //expect(instance).to.be.a(SamsaraApi.HosLogsParam1);
    });
