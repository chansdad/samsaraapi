...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.SensorHistoryResponse();
  });
  ...
  describe('SensorHistoryResponse', function() {
    it('should create an instance of SensorHistoryResponse', function() {
      // uncomment below and update the code to test SensorHistoryResponse
      //var instance = new SamsaraApi.SensorHistoryResponse();
      //expect(instance).to.be.a(SamsaraApi.SensorHistoryResponse);
    });
