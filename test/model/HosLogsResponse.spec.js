...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.HosLogsResponse();
  });
  ...
  describe('HosLogsResponse', function() {
    it('should create an instance of HosLogsResponse', function() {
      // uncomment below and update the code to test HosLogsResponse
      //var instance = new SamsaraApi.HosLogsResponse();
      //expect(instance).to.be.a(SamsaraApi.HosLogsResponse);
    });
