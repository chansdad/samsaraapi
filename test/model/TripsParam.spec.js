...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.TripsParam();
  });
  ...
  describe('TripsParam', function() {
    it('should create an instance of TripsParam', function() {
      // uncomment below and update the code to test TripsParam
      //var instance = new SamsaraApi.TripsParam();
      //expect(instance).to.be.a(SamsaraApi.TripsParam);
    });
