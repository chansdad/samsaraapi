...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DispatchRouteHistory();
  });
  ...
  describe('DispatchRouteHistory', function() {
    it('should create an instance of DispatchRouteHistory', function() {
      // uncomment below and update the code to test DispatchRouteHistory
      //var instance = new SamsaraApi.DispatchRouteHistory();
      //expect(instance).to.be.a(SamsaraApi.DispatchRouteHistory);
    });
