...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DataInputHistoryResponse();
  });
  ...
  describe('DataInputHistoryResponse', function() {
    it('should create an instance of DataInputHistoryResponse', function() {
      // uncomment below and update the code to test DataInputHistoryResponse
      //var instance = new SamsaraApi.DataInputHistoryResponse();
      //expect(instance).to.be.a(SamsaraApi.DataInputHistoryResponse);
    });
