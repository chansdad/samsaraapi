...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SamsaraApi.DvirListResponseMechanicOrAgentSignature();
  });
  ...
  describe('DvirListResponseMechanicOrAgentSignature', function() {
    it('should create an instance of DvirListResponseMechanicOrAgentSignature', function() {
      // uncomment below and update the code to test DvirListResponseMechanicOrAgentSignature
      //var instance = new SamsaraApi.DvirListResponseMechanicOrAgentSignature();
      //expect(instance).to.be.a(SamsaraApi.DvirListResponseMechanicOrAgentSignature);
    });
